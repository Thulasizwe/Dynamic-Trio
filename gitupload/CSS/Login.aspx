    ...
    <form id="form1" runat="server">
        ...
        <%--    ***OLD WAY WITH NORMAL ASP.NET CONTROLS***
            ...
            <dx:ASPxPopupControl runat="server" ShowCloseButton="False" 
                ...
                HeaderText="Login" Height="240px" Width="286px" Theme="BlackGlass">
               <ContentCollection>
                          ...
                          <PanelCollection>
                            <dx:PanelContent ID="PanelContent2" runat="server">
                                  <table runat="server" align="center">
                                      ...
                                      <tr><td class="style1"></td></tr><tr id="Tr1" runat="server" align="center">
                                          <td>
                                            <dx:ASPxButton runat="server" ID="ASPxButton1" Text="Register" 
                                                   Theme="Moderno" OnClick="ASPxButton1_Click"/>
                                              &nbsp;&nbsp;
                                            </td>
                                       </tr>
                                  </table>
