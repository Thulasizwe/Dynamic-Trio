<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Leagues.aspx.cs" Inherits="Leagues" %>
	...
	<body>
		...
		<header class="blue">
				<ul>
					...
					<li><a href="Leagues.aspx" class="active">Leagues</a></li>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT LeagueName, NumberOfTeams , Available FROM SetupLeague  ">
        </asp:SqlDataSource>
        <br />
			</form>	
