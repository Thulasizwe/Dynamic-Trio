...
public partial class Captain : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Insert into SetupLeague values('" + DropDownList1.SelectedValue + "','" + DropDownList2.SelectedValue + "','" + TextBox1.Text + "','" + TextBox2.Text + "')", con);
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if ((FileUpload1.PostedFile != null) && (FileUpload1.PostedFile.ContentLength > 0))
            {
                ...
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("Insert into Results values('" + YourTeamDrop.SelectedValue + "','" + OpponentDrop.SelectedValue + "','" + YourText.Text + "','" + OpponentText.Text + "','" + SaveLocation + "')", con);
                    cmd.ExecuteNonQuery();
                    //
