...
<body>
    ...
    <div>
            ...
            <section id="loginSection">
                <ul>
                    ...
                    <p></p>
                        ...
                        <asp:Label ID="CompanySite" runat="server" AssociatedControlID="ddlSite" >City:   <br/></asp:Label>
                        <asp:TextBox runat="server" ID="ddlSite" AutoCompleteType="Disabled"></asp:TextBox>
                        <asp:Label runat="server" ID="SiteEmpty" AssociatedControlID="ddlSite" Text="The city can not be empty" Visible="false" ForeColor="red" ></asp:Label>
        ...
        <asp:PlaceHolder ID="PlaceHolder1" runat="server">
            <asp:Button runat="server" ID="RegisterButton" Text="Register" OnClick="RegisterButton_Click" Enabled="True"/>
        </asp:PlaceHolder>
