...
<asp:PlaceHolder ID="PlaceHolder1" runat="server" >
        <a target="blank" href="http://up.ac.za/"><asp:Image ID="Image1" runat="server" ImageUrl="~/Images/logo.jpg" /></a>
</asp:PlaceHolder>
<p/>
<style >
  ...
  <td>
    ...
    <Items>
        ...
        <dx:MenuItem Text="Products">
            <Items>
            <dx:MenuItem Text="Add Product" NavigateUrl="~/addProducts.aspx"></dx:MenuItem>
            <dx:MenuItem Text="View Products" NavigateUrl="~/ViewProducts.aspx"></dx:MenuItem>
            </Items>
        </dx:MenuItem>
...
<dx:ASPxPopupControl ID="popup" PopupHorizontalAlign="WindowCenter" 
        PopupVerticalAlign="WindowCenter" HeaderText="About E-Sports Manager"
                        AllowDragging="True" PopupElementID="PopupButton" 
        CloseAction="OuterMouseClick" PopupAction="LeftMouseClick" 
        ShowCloseButton="True" runat="server" Width="728px">
  <ContentCollection>    
    <dx:PopupControlContentControl runat="server" >
        <asp:panel ID="popupPanel" runat="server">
            <table>
                <tr>
                   <td>
            <a href="http://derivco.co.za" target="_blank"><dx:ASPxImage runat="server" ImageUrl="~/Images/logo.jpg" ></dx:ASPxImage></a></td> <td> </td>
            </tr>
            <tr>
                <td>
                E-sports League <br/>
